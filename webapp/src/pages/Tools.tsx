    ...
    <div className="space-y-6 py-4 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Home Assistant tools for AI clients (Cursor, Claude Desktop)
          </p>
        </div>
      </div>
      <div className="rounded-2xl border border-white/10 bg-[#0f0f12]/80 p-5 space-y-4">
        <p className="text-sm text-slate-400">
          ...
          <code className="text-emerald-400">http://localhost:10796/sse</code> (SSE transport).
        </p>
        <div>
          ...
          <p className="text-sm text-slate-400">
            ha(operation=&quot;get_states&quot;), ha(operation=&quot;get_state&quot;,
            entity_id=&quot;...&quot;), ha(operation=&quot;call_service&quot;,
            domain=&quot;light&quot;, service=&quot;turn_on&quot;, entity_id=&quot;...&quot;),
            ha(operation=&quot;get_config&quot;), ha(operation=&quot;get_automations&quot;),
            ha(operation=&quot;trigger_automation&quot;, entity_id=&quot;automation.xxx&quot;)
          </p>
        </div>
        <div>
          <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Help</p>
          <p className="text-sm text-slate-400">
            ha_help(category=...) — categories: get_states, call_service, get_config, automations,
            connection
          </p>
        </div>
        <div>
          ...
          <p className="text-sm text-slate-400">
            ha_agentic_workflow(goal=&quot;...&quot;) — LLM plans and runs get_states, get_state,
            call_service, trigger_automation
          </p>
        </div>
        <div>
          <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">
