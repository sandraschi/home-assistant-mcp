...
import { Activity, Home, Zap, ShieldCheck, HardDrive, AlertCircle, Lightbulb, Thermometer, Shield } from "lucide-react";
        ...
        <div className="space-y-8 page-enter">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4 glass-card">
                    <CardHeader>
                        <CardTitle className="text-xl font-bold uppercase tracking-widest text-orange-500/70">State Changes</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="col-span-3 glass-card">
                    <CardHeader>
                        <CardTitle className="text-xl font-bold uppercase tracking-widest text-orange-500/70">System Health</CardTitle>
                    </CardHeader>
                    <CardContent>
