...
app = FastAPI(title="Home Assistant MCP", lifespan=lifespan)
...
@app.get("/api/health")
async def health():
    return {"status": "ok", "server": "Home Assistant MCP", "version": "0.1.0"}

if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="127.0.0.1", port=10835)
