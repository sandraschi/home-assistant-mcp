...
4. Start the server:
   ...
   uv run uvicorn home_assistant_mcp.server:app --port 10835
   ```
...
5. Open `http://localhost:10835` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/home-assistant-mcp/issues) |
